...
QString fileDirBrowseText = 
  fileInputPage::tr ("This button allows you to select multiple input files by specifiying a top level directory.  All files "
                     "below the selected directory will be searched for CZMIL CPF files.  These files will be added to the "
...
QString fileInputFilesText = 
  fileInputPage::tr ("This is a list of all files that will be read to create the CZMIL Audit Files (*.caf).  You may "
